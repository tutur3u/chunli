...
const ABOUT_TRAITS = [
	{
		...
		description: "Soft-console interfaces, nostalgic product worlds, and tactile UI that feels collectible.",
		icon: <Sparkles className="h-5 w-5" />,
		accent: "from-cyan-300 via-sky-400 to-blue-500",
	},
	{
		title: "Build Style",
		description: "Frontend systems shaped around motion, playful interaction, and memorable visual identity.",
		icon: <Zap className="h-5 w-5" />,
		accent: "from-emerald-300 via-lime-400 to-yellow-300",
	},
	{
		title: "Creative Energy",
		description: "A balance of polish and warmth, with enough weirdness to keep things from feeling generic.",
...
const ABOUT_SIGNALS = [
	{ label: "Frontend Craft", value: "94%", width: "w-[94%]" },
	{ label: "Visual Systems", value: "91%", width: "w-[91%]" },
	{ label: "Interaction Polish", value: "96%", width: "w-[96%]" },
	{ label: "Experimental Energy", value: "88%", width: "w-[88%]" },
] as const;
